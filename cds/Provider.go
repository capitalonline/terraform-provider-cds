...
func Provider() terraform.ResourceProvider {
	...
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"cds_data_source_dedicated_host":       dataSourceDedicatedHost(),
			"cds_data_source_dedicated_host_types": dataSourceDedicatedHostType(),
			"cds_data_source_subjects":             dataSourceCdsSubjects(),
		},
		ResourcesMap: map[string]*schema.Resource{
			...
			"cds_dedicated_host": resourceCdsDedicatedHost(),
		},
